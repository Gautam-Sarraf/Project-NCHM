...
export default function ContactPage() {
  ...
  const inputClasses =
    "w-full px-4 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder:text-white/25 focus:outline-none focus:border-[#D4A533]/40 focus:shadow-[0_0_20px_rgba(212,165,51,0.1)] transition-all duration-300"
      ...
      <section className="relative py-16 md:py-24">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <motion.p
            ...
            className="mt-5 text-white/50 max-w-lg mx-auto leading-relaxed"
          >
              ...
              <div className="glass-card-white rounded-2xl p-8 md:p-10 gold-glow">
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {walletAddress ? (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-sm text-white/50 truncate">{walletAddress}</p>
                        </div>
                      </motion.div>
                    ) : (
                      <motion.button
                        ...
                        disabled={connecting}
                        className="w-full flex items-center justify-center gap-3 py-3.5 px-6 rounded-xl border border-white/10 text-white/70 text-sm font-medium hover:bg-white/5 hover:border-[#D4A533]/20 transition-all duration-300 disabled:opacity-50"
                      >
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label htmlFor="name" className="block text-xs text-white/50 mb-2 uppercase tracking-wider">Full Name</label>
                    ...
                    <div>
                      <label htmlFor="email" className="block text-xs text-white/50 mb-2 uppercase tracking-wider">Email</label>
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-xs text-white/50 mb-2 uppercase tracking-wider">Phone Number</label>
                  ...
                  <div>
                    <label htmlFor="message" className="block text-xs text-white/50 mb-2 uppercase tracking-wider">Message</label>
